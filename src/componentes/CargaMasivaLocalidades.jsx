...
const CargaMasivaLocalidades = () => {
    ...
    const subirArchivo = async () => {
        ...
        try {
            const response = await axios.post(`${URL_LOCALIDADESCONTROLLER}/crearLocalidadMasivas`, formData, {
                headers: {
...
export default CargaMasivaLocalidades;