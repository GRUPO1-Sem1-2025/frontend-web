...
import logo from "./logoBase64.js";
...
export default function imprimirPasaje(pasaje) {
        ...
        columns: [
          {
            text:
              ...
              pasaje.fechaSalida +
              " - " +
              pasaje.horaSalida.substring(0, 5),
          },
          {
            text:
              "Llegada: " +
              pasaje.fechaArribo +
              " - " +
              pasaje.horaArribo.substring(0, 5),
          },
        ],
      },
      {
      ...
      { text: "\n" },
      {
        columns: [
          ...
          pasaje.origen === "Montevideo"
            ? {
                stack: [
                  { text: "Acceso a andenes", style: "label" },
                  {
  ...
  const docDefinition = {
    ...
    styles: {
      ...
      label: { fontSize: 13, bold: true, margin: [0, 10, 0, 4] },
    },
